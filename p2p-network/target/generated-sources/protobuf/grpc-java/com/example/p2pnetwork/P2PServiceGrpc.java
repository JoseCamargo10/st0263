...
public final class P2PServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.p2pnetwork.P2PServiceProto.DisconnectRequest,
      com.example.p2pnetwork.P2PServiceProto.DisconnectResponse> getNotifyDisconnectionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "notifyDisconnection",
      requestType = com.example.p2pnetwork.P2PServiceProto.DisconnectRequest.class,
      responseType = com.example.p2pnetwork.P2PServiceProto.DisconnectResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.p2pnetwork.P2PServiceProto.DisconnectRequest,
      com.example.p2pnetwork.P2PServiceProto.DisconnectResponse> getNotifyDisconnectionMethod() {
    io.grpc.MethodDescriptor<com.example.p2pnetwork.P2PServiceProto.DisconnectRequest, com.example.p2pnetwork.P2PServiceProto.DisconnectResponse> getNotifyDisconnectionMethod;
    if ((getNotifyDisconnectionMethod = P2PServiceGrpc.getNotifyDisconnectionMethod) == null) {
      synchronized (P2PServiceGrpc.class) {
        if ((getNotifyDisconnectionMethod = P2PServiceGrpc.getNotifyDisconnectionMethod) == null) {
          P2PServiceGrpc.getNotifyDisconnectionMethod = getNotifyDisconnectionMethod =
              io.grpc.MethodDescriptor.<com.example.p2pnetwork.P2PServiceProto.DisconnectRequest, com.example.p2pnetwork.P2PServiceProto.DisconnectResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "notifyDisconnection"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.p2pnetwork.P2PServiceProto.DisconnectRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.p2pnetwork.P2PServiceProto.DisconnectResponse.getDefaultInstance()))
              .setSchemaDescriptor(new P2PServiceMethodDescriptorSupplier("notifyDisconnection"))
              .build();
        }
      }
    }
    return getNotifyDisconnectionMethod;
  }
  ...
  public static abstract class P2PServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void notifyDisconnection(com.example.p2pnetwork.P2PServiceProto.DisconnectRequest request,
        io.grpc.stub.StreamObserver<com.example.p2pnetwork.P2PServiceProto.DisconnectResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getNotifyDisconnectionMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getNotifyDisconnectionMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.p2pnetwork.P2PServiceProto.DisconnectRequest,
                com.example.p2pnetwork.P2PServiceProto.DisconnectResponse>(
                  this, METHODID_NOTIFY_DISCONNECTION)))
          .build();
    }
  }
  ...
  public static final class P2PServiceStub extends io.grpc.stub.AbstractAsyncStub<P2PServiceStub> {
    ...
    public void notifyDisconnection(com.example.p2pnetwork.P2PServiceProto.DisconnectRequest request,
        io.grpc.stub.StreamObserver<com.example.p2pnetwork.P2PServiceProto.DisconnectResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getNotifyDisconnectionMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class P2PServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<P2PServiceBlockingStub> {
    ...
    /**
     */
    public com.example.p2pnetwork.P2PServiceProto.DisconnectResponse notifyDisconnection(com.example.p2pnetwork.P2PServiceProto.DisconnectRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getNotifyDisconnectionMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class P2PServiceFutureStub extends io.grpc.stub.AbstractFutureStub<P2PServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.p2pnetwork.P2PServiceProto.DisconnectResponse> notifyDisconnection(
        com.example.p2pnetwork.P2PServiceProto.DisconnectRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getNotifyDisconnectionMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_NOTIFY_DISCONNECTION = 3;
      ...
      switch (methodId) {
        ...
        case METHODID_GET_HASH_TABLE:
          serviceImpl.getHashTable((com.example.p2pnetwork.P2PServiceProto.Empty) request,
              (io.grpc.stub.StreamObserver<com.example.p2pnetwork.P2PServiceProto.HashTableResponse>) responseObserver);
          break;
        case METHODID_NOTIFY_DISCONNECTION:
          serviceImpl.notifyDisconnection((com.example.p2pnetwork.P2PServiceProto.DisconnectRequest) request,
              (io.grpc.stub.StreamObserver<com.example.p2pnetwork.P2PServiceProto.DisconnectResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (P2PServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getNotifyDisconnectionMethod())
              .build();
        }
      }
    }
